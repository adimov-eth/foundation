...
An opt-in [arrival-scheme](../arrival/README.md) palette pack that wires [Ramda](https://ramdajs.com/)'s accessor, path, collection, logic, and string verbs into the env.
