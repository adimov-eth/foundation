 ...
 *
 * Propagation algebra: lost: `docs/30-reconciliation/dangling-doc-map.md` §5.
 *
...
/** Per lost: `docs/30-reconciliation/dangling-doc-map.md` §5.1: distinct-by-reference, forward singleton, union ≥2. */
