---
title: MCP architecture refactor (archived)
layer: history
status: verified
tags: [history, arrival, mcp]
canonical-for: []
source-provenance:
  origin: tmp/Archive/arrival/arrival-mcp/docs/mcp-refactor.md
...
> ⚠️ Frozen historical copy — possibly outdated; current truth in [[arrival-mcp]].
