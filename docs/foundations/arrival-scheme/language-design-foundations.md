---
title: Arrival-Scheme — Language Design Foundations
layer: history
status: in-review
tags: [history, recovered, arrival, scheme, language-design, reader, serializer]
canonical-for: []
source-provenance:
  origin: user-supplied recovered source
  branch: post-snapshot successor lineage
  retrieved: 2026-07-21
  authority: historical
last-verified: 2026-07-21
verified-against: claude/welcome-fix-and-architecture-docs
---

> **Recovered source with a lineage boundary.** This document was supplied on 2026-07-21 and
> restores the previously missing canonical path. Its 2026-07-02 amendment describes a later
> successor/private lineage: this repository snapshot still reads square brackets as lists and
> enables curly-infix by default (`arrival/arrival/src/__tests__/curly-infix.test.ts:160-171`).
> Treat the amendment as historical upstream direction, not as implemented behavior in this tree.
...
Companions:
- [`R7RS-COMPLIANCE.md`](../../package-specific/arrival-scheme/R7RS-COMPLIANCE.md) — the conformance matrix for the base.
- [`sandbox-security-model.md`](../../package-specific/arrival-scheme/sandbox-security-model.md) — the no-IO boundary.
