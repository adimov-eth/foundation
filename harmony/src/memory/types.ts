/**
 * Memory types - clean extraction from vessel
 * Branded types for type safety, Result monad for error handling
 */
...
export type MemoryError =
  ...
  | { tag: 'NotFoundError'; id: string; type: string }
  | { tag: 'DuplicateError'; id: string }
...
export const NotFoundError = (id: string, type: string): MemoryError => ({
  tag: 'NotFoundError', id, type
});

export const DuplicateError = (id: string): MemoryError => ({
...
// ============================================================================
// Policy Types (executable S-expressions)
// ============================================================================
...
export interface MemoryPolicy {
  ...
  neighborTopK?: number;
  maxPairsPerRecall?: number;
  coactTopKPerNode?: number;
}
